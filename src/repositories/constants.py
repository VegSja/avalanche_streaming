...
AVALANCHE_REGIONS: List[AvalancheRegion] = [
    ...
    # AvalancheRegion(
    #     name="Lofoten og Vesterålen", region_id="3014", lat=68.182, lon=13.736
    # ),
    ...
    AvalancheRegion(
        name="Trollheimen",
        region_id="3022",
        west_north_lat=62.969797,
        west_north_lon=8.684849,
        east_south_lat=62.588196,
        east_south_lon=9.704101,
    ),
